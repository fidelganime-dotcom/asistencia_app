  ...
  Future<void> _eliminarRegistro(Asistencia registro) async {
    final confirmar = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
            'Eliminar registro de ${registro.nombreCompleto} del ${registro.fecha.day}/${registro.fecha.month}/${registro.fecha.year}?'),
        actions: [
          TextButton(
  ...
  Future<void> _confirmarEliminarTodos() async {
    final confirmar = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
            'Esta accion eliminara TODOS los registros de asistencia. No se puede deshacer.'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context, false),
            child: const Text('Cancelar'),
